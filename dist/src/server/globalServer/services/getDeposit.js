...
export var getDeposit = function (_a) {
    ...
    return function (input) { return __awaiter(_this, void 0, void 0, function () {
        var accountId, roomId, roomDeposit;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    accountId = input.accountId, roomId = input.roomId;
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            ok: true,
                            payload: {
                                depositAmountInCents: roomDeposit ? roomDeposit.depositAmountInCents : 0,
                            }
                        }];
            }
        });
...
//# sourceMappingURL=getDeposit.js.map