...
/**
 * Updates the room status in the server every x time.
 */
export var roomServerPingUpdate = function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, models.RoomServer.update({
                            lastPing: new Date(),
                            updatedAt: new Date(),
                        }, {
                            where: {
...
//# sourceMappingURL=roomServerPingUpdate.js.map