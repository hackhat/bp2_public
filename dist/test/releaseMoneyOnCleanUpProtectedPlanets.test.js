 ...
 * Tests:
 *
 *  - Clean up protected planets task only removes ownership of protected planets and not unprotected ones
 *  - Will release the money to the player
 */
test("releaseMoneyOnCleanUpProtectedPlanets", function () { return __awaiter(_this, void 0, void 0, function () {
    var bigBoss, UNITS;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 8:
                ...
                // Own 2 more planets
                console.time("sendShipAndWaitUntilArrives");
                UNITS = 40;
                return [4 /*yield*/, Promise.all([
                        bigBoss.sendShipAndWaitUntilArrives({
            ...
            case 9:
                _a.sent();
                console.timeEnd("sendShipAndWaitUntilArrives");
                console.time("checkDepositForAccountId1");
                return [4 /*yield*/, expectPlayerMoneyToBe(bigBoss, DEFAULT_MONEY_IN_CENTS_WHEN_STARTING_NEW_GAME)];
            case 10:
                _a.sent();
            ...
            case 11:
                _a.sent();
                console.timeEnd("checkDepositForAccountId1");
                // Disconnect
...
//# sourceMappingURL=releaseMoneyOnCleanUpProtectedPlanets.test.js.map